          ...
          <div className="flex flex-col gap-4">
            {home.evidence.areas.map(([title, body], i) => {
              ...
              return (
                ...
                >
                  <div className="group relative flex gap-5 rounded-xl border border-line bg-page p-6 emfi-card-lift">
                    <span className="relative z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-md border border-line bg-subtle text-ink">
                      <Icon size={18} />
                    </span>
