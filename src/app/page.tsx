      ...
      <section className="border-y border-line bg-subtle">
        <Container className="py-12 md:py-16">
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_0.9fr]">
            <FadeIn>
              <Eyebrow>{home.chainEyebrow}</Eyebrow>
              <h2 className="text-4xl font-extrabold tracking-[-0.035em] text-ink md:text-5xl">
                {home.chainTitle}
              </h2>
              <p className="mt-5 max-w-xl text-lg font-medium leading-8 text-ink-secondary">
                {home.chainBody}
              </p>
            </FadeIn>
            <FadeIn delay={0.1}>
              <InfrastructureRotator />
            </FadeIn>
          </div>
          <div className="mt-10">
            <p className="font-mono text-[11px] font-bold uppercase tracking-[0.16em] text-ink-muted">
              {home.infraLogosEyebrow}
            </p>
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {home.chainInfra.map((item) => (
                <div
                  key={item.name}
                  className="rounded-lg border border-line bg-page px-5 py-4"
                >
            ...
            <p className="mt-4 max-w-3xl text-xs leading-5 text-ink-muted">
              {home.infraNote}
            </p>
          </div>
        </Container>
